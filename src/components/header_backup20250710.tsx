...
export default function Header() {
    ...
    // }, [])
                    ...
                    //         </div>
                    //         <span className="hidden md:inline text-gray-900 font-bold">My</span>
                    ...
                    //     {/* Dropdown menu */}
                    //     {isDropdownOpen && (
                    //         <div ref={dropdownRef} className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50 border border-gray-200">
                    //             <ul className="py-1">
                    //                 <li>
